...
public class FormDemoVerify extends javax.swing.JFrame {
    ...
    private void jBtnCallVerifyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnCallVerifyActionPerformed
        ...
        Verify_Service verifyWS=new Verify_Service();   
        Verify verifyClient= verifyWS.getVerifyPort();
       
        // valorizzazione input
        InputCommon inVerify=new InputCommon();
        inVerify.setLocalita(jTxtComuneIn.getText());
        inVerify.setProvincia(jTxtProvIn.getText());
        inVerify.setCap(this.jTxtCAPIn.getText());
        inVerify.setIndirizzo(jTxtIndirizzoIn.getText());
        
        // chiamata al servizio
        totOut=verifyClient.verify(inVerify, jTxtKey.getText());
